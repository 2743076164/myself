...
<body>
	...
	<div class="box-body">
		...
		<div class="nav-tabs-custom">
			...
			<ul class="nav nav-tabs">
				...
				<li><a href="#tab-treetable" data-toggle="tab">订单汇总</a></li>
			...
			<div class="tab-pane" id="tab-treetable">
				<table id="collapse-table1"
					...
					<thead>
						<tr style="color: green; font-size: 26px;">
							<th>订单</th>
	...
	<script
		src="${pageContext.request.contextPath}/admin/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
	<script
		src="${pageContext.request.contextPath}/admin/plugins/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.zh-CN.js"></script>
	<script>
